          ...
          <div class="max-w-xl lg:max-w-3xl">
            ...
            <div>
              ...
              <select
                ...
                class="mt-1.5 px-2 h-10 w-full rounded-lg border-gray-300 text-gray-700 sm:text-sm"
              >
...
const individualrules = computed(() => ({
  firstname: { required },
  lastname: { required },
...
const companyrules = computed(() => ({
  ...
  company_confirm_password: {
    required,
    sameAs: sameAs(company.companypassword),
  },
...
watchEffect(() => {
  if (selectedType.value === "individual") {
    return (v$ = useVuelidate(individualrules, individual, {
      $autoDirty: true,
    }));
  } else if (selectedType.value === "company") {
    return (v$ = useVuelidate(companyrules, company, { $autoDirty: true }));
  }
});
